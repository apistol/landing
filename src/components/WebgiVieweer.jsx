...
import {
    ...
    ProgressivePlugin,
    mobileAndTabletCheck, AssetManagerBasicPopupPlugin, TweakpaneUiPlugin, CanvasSnipperPlugin,
} from "webgi";
...
const WebgiViewer = forwardRef((props, ref) => {
    ...
    const setupViewer = useCallback(async () => {
        ...
        await manager.addFromPath(`forrest.glb`);

        viewer.getPlugin(TonemapPlugin).config.clipBackground = true;

        viewer.scene.activeCamera.setCameraOptions({ controlsEnabled: false });

            position.set(-16.7, -10001.17, 11.7);
            target.set(-100, -10000, -10000);
